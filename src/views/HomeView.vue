<template>
  <div class="home">
    <div class="featured-card">
      <router-link to="/movie/aaaa">
        <img
          src="https://photos.tf1.fr/780/780/perso-showpage-naruto-70c311-7cdbc0-0@1x.png"
          alt="Naruto Poster"
          class="featured-img"
        />
        <div class="detail">
    ...
    <form @submit.prevent="SearchMovies()" class="s search-box">
      <input
        type="text"
